    ...
    public void resetValidators(Context context) {
        ...
        switch (testType) {
            ...
            case TEST_NUMERIC_RANGE:
                toAdd =
                        new NumericRangeValidator(TextUtils.isEmpty(testErrorString) ? context.getString(R.string.error_only_numeric_digits_range_allowed, Integer.toString(minNumber), Integer.toString(maxNumber))
                                : testErrorString, minNumber, maxNumber);
                break;
            case TEST_FLOAT_NUMERIC_RANGE:
                toAdd =
                        new FloatNumericRangeValidator(TextUtils.isEmpty(testErrorString) ? context.getString(R.string.error_only_numeric_digits_range_allowed, Float.toString(floatminNumber), Float.toString(floatmaxNumber))
